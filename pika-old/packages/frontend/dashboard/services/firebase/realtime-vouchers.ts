...
class RealtimeVoucherService {
  ...
  /**
   * Subscribe to real-time voucher statistics for a provider
   */
  subscribeToStats(
    providerId: string,
    ...
    const statsRef = doc(firestore, 'voucherStats', providerId)
  ...
  /**
   * Subscribe to real-time voucher updates for a provider
   */
  subscribeToUpdates(
    providerId: string,

...
export enum ErrorCode {
  ...
  CATEGORY_PARENT_LOOKUP_FAILED = 'CATEGORY_PARENT_LOOKUP_FAILED',
  CATEGORY_PARENT_NOT_FOUND = 'CATEGORY_PARENT_NOT_FOUND',
  CATEGORY_PARENT_ALREADY_EXISTS = 'CATEGORY_PARENT_ALREADY_EXISTS',
...
export function getStatusCodeForError(code: ErrorCode): number {
  switch (code) {
    ...
    case ErrorCode.CATEGORY_PARENT_NOT_FOUND:
      return 404
    ...
    case ErrorCode.CATEGORY_PARENT_ALREADY_EXISTS:
    case ErrorCode.CATEGORY_ALREADY_EXISTS:
...
export function getDefaultMessageForError(code: ErrorCode): string {
  switch (code) {
    ...
    // Category parent-related errors
    case ErrorCode.CATEGORY_PARENT_LOOKUP_FAILED:
      return 'Failed to lookup category parent'

    case ErrorCode.CATEGORY_PARENT_NOT_FOUND:
      return 'Category parent not found'

    case ErrorCode.CATEGORY_PARENT_ALREADY_EXISTS:
      return 'Category parent already exists'

    // Category-related errors
    case ErrorCode.CATEGORY_LOOKUP_FAILED:
      return 'Failed to lookup category'

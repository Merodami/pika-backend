 ...
 */
export async function startVoucherService(options?: {
  repositories?: {
    read?: any
    write?: any
  }
  ...
  logger.info(
    `Unified Voucher service starting on port: ${VOUCHER_SERVER_PORT}`,
  )
  ...
  // Start the server
  await startServer(app, VOUCHER_SERVER_PORT, {
    onShutdown: async () => {

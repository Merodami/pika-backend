 ...
 */
export async function startUserService(options?: {
  repositories?: {
    read?: any
    write?: any
  }
  ...
  logger.info(`Unified User service starting on port: ${USER_SERVER_PORT}`)
  ...
  // Start the server
  await startServer(app, USER_SERVER_PORT, {
    onShutdown: async () => {

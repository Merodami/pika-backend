 ...
 */
export function createAdminVoucherBookRoutes(adminVoucherBookController: AdminVoucherBookController): Router {
  const router = Router()

  // GET /admin/voucher-books/statistics - Get voucher book statistics (before parameterized routes)
  router.get(
    '/statistics',
    validateQuery(VoucherBookStatsQueryParams),
  ...
  router.get(
    '/',
    validateQuery(AdminVoucherBookQueryParams),
  ...
  router.post(
    '/',
    validateBody(CreateVoucherBookRequest),
  ...
  router.patch(
    '/:id',
    validateParams(VoucherBookIdParam),
    validateBody(UpdateVoucherBookRequest),
  ...
  router.post(
    '/:id/status',
    validateParams(VoucherBookIdParam),
    validateBody(UpdateVoucherBookStatusRequest),
  ...
  router.post(
    '/:id/generate-pdf',
    validateParams(VoucherBookIdParam),
    validateBody(GeneratePDFRequest),
  ...
  router.post(
    '/bulk-archive',
    validateBody(BulkArchiveVoucherBooksRequest),

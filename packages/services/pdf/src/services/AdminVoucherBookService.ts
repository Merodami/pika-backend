...
export interface IAdminVoucherBookService {
  getAllVoucherBooks(params: AdminVoucherBookSearchParams): Promise<PaginatedResult<VoucherBook>>
  ...
  updateVoucherBookStatus(id: string, status: VoucherBookStatus, userId: string): Promise<VoucherBook>
 ...
 */
export class AdminVoucherBookService extends VoucherBookService implements IAdminVoucherBookService {
  /**
  ...
  async updateVoucherBookStatus(
    ...
    try {
      ...
      logger.error('Failed to update voucher book status', { id, status, error })
      throw ErrorFactory.fromError(error, 'Failed to update voucher book status')
    }
  }
  ...
  async bulkArchiveVoucherBooks(ids: string[], userId: string): Promise<void> {
    try {
      ...
      throw ErrorFactory.fromError(error, 'Failed to bulk archive voucher books')
    }
  }

...
export class AdminCategoryController {
  ...
  async updateCategorySortOrder(
    ...
    try {
      ...
      const category = await this.categoryService.updateCategorySortOrder(id, sortOrder)
  ...
  async getCategoryHierarchy(
    ...
    try {
      ...
      const categories = await this.categoryService.getCategoryHierarchy(query.rootId)

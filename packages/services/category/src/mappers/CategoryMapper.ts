...
export class CategoryMapper {
  ...
  static toDTO(domain: CategoryDomain): CategoryDTO {
    ...
    return {
      ...
      children: domain.children ? domain.children.map(child => this.toDTO(child)) : undefined,
    }
  }
  ...
  static fromDTO(dto: CategoryDTO): CategoryDomain {
    return {
      ...
      children: dto.children ? dto.children.map(child => this.fromDTO(child)) : undefined,
    }
  }
   ...
   */
  static fromSearchParamsDTO(dto: CategorySearchParamsDTO): CategorySearchParams {
    return {
      search: dto.search,
      parentId: dto.parentId,
      isActive: dto.isActive,
   ...
   */
  static fromCreateRequestDTO(dto: CreateCategoryRequestDTO, createdBy: string): CreateCategoryData {
    return {
      nameKey: dto.nameKey,
      descriptionKey: dto.descriptionKey,
      icon: dto.icon,
   ...
   */
  static fromUpdateRequestDTO(dto: UpdateCategoryRequestDTO, updatedBy: string): UpdateCategoryData {
    return {
      nameKey: dto.nameKey,
      descriptionKey: dto.descriptionKey,
      icon: dto.icon,
   ...
   */
  static toPaginatedDTO(result: PaginatedResult<CategoryDomain>): PaginatedResult<CategoryDTO> {
    return {

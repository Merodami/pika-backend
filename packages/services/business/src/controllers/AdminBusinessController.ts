import { mapSortOrder } from '@pika/api'
import { adminBusinessSortFieldMapper } from '@pika/api/admin'
import type {
...
export class AdminBusinessController {
  ...
  async getAllBusinesses(
    ...
    try {
      const query = getValidatedQuery<AdminBusinessQueryParams>(req)
      ...
      const params = {
        ...
        sortBy: adminBusinessSortFieldMapper.mapSortField(query.sortBy, 'createdAt'),
  ...
  async createBusiness(
    req: Request<{}, {}, AdminCreateBusinessRequest>,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
    try {
  ...
  async updateBusiness(
    req: Request<BusinessIdParam, {}, AdminUpdateBusinessRequest>,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
    try {
      ...
      const business = await this.businessService.updateBusiness(businessId, data)
  ...
  async verifyBusiness(
    req: Request<BusinessIdParam, {}, VerifyBusinessRequest>,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
    try {
  ...
  async activateBusiness(
    ...
    try {
      ...
      const business = await this.businessService.updateBusiness(businessId, { active: true })
  ...
  async updateBusinessRating(
    req: Request<BusinessIdParam, {}, UpdateBusinessRatingRequest>,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
    try {
      ...
      const business = await this.businessService.updateBusinessRating(businessId, rating)

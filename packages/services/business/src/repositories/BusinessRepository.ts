...
import { ErrorFactory, ErrorSeverity, logger, type ParsedIncludes } from '@pika/shared'
...
export interface IBusinessRepository {
  findAll(params: BusinessSearchParams): Promise<PaginatedResult<BusinessDomain>>
  findById(id: string, includes?: ParsedIncludes): Promise<BusinessDomain | null>
  findByUserId(userId: string, includes?: ParsedIncludes): Promise<BusinessDomain | null>
...
export class BusinessRepository implements IBusinessRepository {
   ...
   */
  private buildWhereClause(params: BusinessSearchParams): Prisma.BusinessWhereInput {
    ...
    if (params.search) {
      where.OR = [
        ...
        { businessDescriptionKey: { contains: params.search, mode: 'insensitive' } },
      ]
    }
   ...
   */
  private buildOrderByClause(params: BusinessSearchParams): Prisma.BusinessOrderByWithRelationInput {
   ...
   */
  private buildIncludeClause(includes?: ParsedIncludes): Prisma.BusinessInclude {
   ...
   */
  async findById(id: string, includes?: ParsedIncludes): Promise<BusinessDomain | null> {
    try {
   ...
   */
  async findByUserId(userId: string, includes?: ParsedIncludes): Promise<BusinessDomain | null> {
    try {
      // Try to get from cache first

...
publicRegistry.registerSchema('AuthTokensResponse', authSchemas.AuthTokensResponse)
...
publicRegistry.registerSchema('IntrospectRequest', oauthSchemas.IntrospectRequest)
publicRegistry.registerSchema('IntrospectResponse', oauthSchemas.IntrospectResponse)
publicRegistry.registerSchema('RevokeTokenRequest', oauthSchemas.RevokeTokenRequest)
publicRegistry.registerSchema('RevokeTokenResponse', oauthSchemas.RevokeTokenResponse)

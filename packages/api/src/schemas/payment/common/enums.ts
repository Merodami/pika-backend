...
export const PriceInterval = z.enum([
  'day',
  'week',
  'month',
  'year',
...
export const TransactionSortBy = z.enum([
  'createdAt',
  'amount',
  'processedAt',
])
...
export const RefundInitiator = z.enum([
  'user',
  'system',
  'admin',
])
...
export const PayoutAction = z.enum([
  'approve',
  'reject',
  'delay',
])
...
export const PromoCodeType = z.enum([
  'percentage',
  'fixedAmount',
])
...
export const ReportPeriod = z.enum([
  '7d',
  '30d',
  '90d',
  '1y',
...
export const DisputeAction = z.enum([
  'accept',
  'challenge',
])

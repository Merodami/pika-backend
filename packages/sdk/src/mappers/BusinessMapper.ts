...
export class BusinessMapper {
  ...
  static fromDocument(doc: BusinessDocument): BusinessDomain {
    return {
      ...
      category: doc.category ? CategoryMapper.fromDocument(doc.category) : undefined,
    }
  }
  ...
  static toDTO(domain: BusinessDomain): BusinessDTO {
    ...
    return {
      ...
      category: domain.category ? CategoryMapper.toDTO(domain.category) : undefined,
    }
  }
  ...
  static fromUpdateDTO(dto: UpdateBusinessDTO): UpdateBusinessData {
    ...
    if (dto.businessNameKey !== undefined) updates.businessNameKey = dto.businessNameKey
    if (dto.businessDescriptionKey !== undefined) updates.businessDescriptionKey = dto.businessDescriptionKey

...
export class CategoryMapper {
  ...
  static fromDocument(doc: CategoryDocument): CategoryDomain {
    return {
      ...
      children: doc.children ? doc.children.map(child => this.fromDocument(child)) : undefined,
    }
  }
  ...
  static fromUpdateDTO(dto: UpdateCategoryDTO): UpdateCategoryData {
    ...
    if (dto.descriptionKey !== undefined) updates.descriptionKey = dto.descriptionKey
